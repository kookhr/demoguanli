...
export const SearchSkeleton = () => {
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 animate-pulse">
      <div className="p-4">
        <div className="h-12 bg-gray-200 dark:bg-gray-700 rounded-lg mb-3"></div>
        <div className="flex gap-2">
...
// 状态统计骨架屏
export const StatusStatsSkeleton = () => {
  return (
    <div className="grid grid-cols-2 gap-3 sm:grid-cols-4 sm:gap-4 animate-pulse">
      {Array.from({ length: 4 }).map((_, index) => (
        <div key={index} className="bg-gray-200 dark:bg-gray-700 rounded-lg p-4 text-center">
          <div className="h-8 bg-gray-300 dark:bg-gray-600 rounded mb-2 mx-auto w-12"></div>
